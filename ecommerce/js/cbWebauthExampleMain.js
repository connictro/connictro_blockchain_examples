...
async function loginCredsSelected(_rawFileData){
  ...
  if (_credsRoot.ListOfClientCredentials.length > 1){
    ...
    doJustSignin(goodLoginCallback, badLoginCallbackManual, gCookieContent.nodeUrl, selectedCreds.clientKey, _credsRoot.encHash, selectedCreds.clientCertificate);  
  }
}
